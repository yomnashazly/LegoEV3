...
//var { codex } = require('/blockly-master/demos/codelab/myapp/scripts/functions.js')
//import {codex} from '/blockly-master/demos/codelab/myapp/scripts/functions.js'
...
function init() {
	...
	// });
	 ...
	 imgTexture = THREE.ImageUtils.loadTexture( "/blockly-master/LegoMinstormSimulation/colour.jpg" );
...
function displayRobotSim() {
	if ( robot == "complexRobot" ) {
		...
		function handle_load( gltf ) {
			...
			var loader = new THREE.ObjectLoader();
			loader.load( "/blockly-master/LegoMinstormSimulation/LegoRobot/wheel.dae (1).json", function ( object2 ) {
				//group = new THREE.Group();
			...
			var loader = new THREE.ObjectLoader();
			loader.load( "/blockly-master/LegoMinstormSimulation/LegoRobot/wheel.dae (1).json", function ( object3 ) {
				//group = new THREE.Group();
			...
			var loader = new THREE.ObjectLoader();
			loader.load("/blockly-master/LegoMinstormSimulation/LegoRobot/wheel.dae (1).json", function ( object4 ) {
				//group = new THREE.Group();
			...
			var loader = new THREE.ObjectLoader();
			loader.load("/blockly-master/LegoMinstormSimulation/LegoRobot/wheel.dae (1).json", function ( object5 ) {
				//group = new THREE.Group();
			...
			var loader = new THREE.ObjectLoader();
			loader.load( "/blockly-master/LegoMinstormSimulation/LegoRobot/wheel.dae (1).json", function ( object6 ) {
				//group = new THREE.Group();
			...
			var loader = new THREE.ObjectLoader();
			loader.load( "/blockly-master/LegoMinstormSimulation/LegoRobot/wheel.dae (1).json", function ( object7 ) {
				//group = new THREE.Group();
